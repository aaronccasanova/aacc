...
const completion = await chain.invoke({
  question:
    'Find all package.json files in the current directory and all subdirectories and print their location of they contain "@prompt-template/core".',
})

console.log(completion)
// 'find . -name "package.json" -exec grep -l "@prompt-template/core" {} \;'
