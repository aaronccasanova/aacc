// Copy/paste from `title-case` to enable support for ESM and CJS:
// https://github.com/blakeembrey/change-case/blob/f6ce967f7d287d38ab17063943f99864268947f9/packages/title-case/src/index.ts
//
// @ts-nocheck
/* eslint-disable */
